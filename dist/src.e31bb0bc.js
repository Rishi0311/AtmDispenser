...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"components/ReturnResult.js":[function(require,module,exports) {
"use strict";
...
var ReturnResult = function ReturnResult(props) {
  var newObj = props.value;
  var noOfNotes = props.count;
  return Object.keys(newObj).map(function (key, i) {
    return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("table", {
      ...
      key: i
    }, _react.default.createElement("td", null, _react.default.createElement("span", null, "Denomination: ", key)), _react.default.createElement("td", null, _react.default.createElement("span", null, "No of Notes:", newObj[key]))))));
  });
};

var _default = ReturnResult;
exports.default = _default;
},{"react":"../node_modules/react/index.js"}],"components/MinNotes.js":[function(require,module,exports) {
"use strict";
...
var MinNotes = function MinNotes(props) {
  return _react.default.createElement("div", null, _react.default.createElement("h2", null, "Min no of notes to be despensed: ", props.count));
};

var _default = MinNotes;
exports.default = _default;
},{"react":"../node_modules/react/index.js"}],"components/Dispenser.js":[function(require,module,exports) {
"use strict";
...
var _ReturnResult = _interopRequireDefault(require("./ReturnResult"));

var _MinNotes = _interopRequireDefault(require("./MinNotes"));
...
var Dispenser = function Dispenser(props) {
  var amount = props.value;
  var denom = [1, 2, 5, 10, 20, 50, 100, 500, 1000];
  var n = denom.length;
  var ans = [];
  ...
  var res = ans.reduce(function (counter, item) {
  ...
  var finalRes = _objectSpread({}, initialObj, {}, res);

  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_ReturnResult.default, {
    value: finalRes
  }), _react.default.createElement(_MinNotes.default, {
    count: ans.length
  })); //console.log(finalRes);
};

var _default = Dispenser;
exports.default = _default;
},{"react":"../node_modules/react/index.js","./ReturnResult":"components/ReturnResult.js","./MinNotes":"components/MinNotes.js"}],"components/GetAmount/GetAmount.js":[function(require,module,exports) {
"use strict";
...
var _Dispenser = _interopRequireDefault(require("../Dispenser"));
...
function (_React$Component) {
  _inherits(GetAmount, _React$Component);

  function GetAmount(props) {
    var _this;

    _classCallCheck(this, GetAmount);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(GetAmount).call(this, props));

    _defineProperty(_assertThisInitialized(_this), "calculate", function (e) {
      e.preventDefault();

      _this.setState({
        value: _this.amountRef.current.value
      }); //alert('Value passed:',this.state.value);

    });

    _this.amountRef = _react.default.createRef();
    _this.state = {
      value: ''
    };
    return _this;
  ...
  _createClass(GetAmount, [{
    ...
    value: function render() {
      ...
      }, "ATM Money Dispenser")), _react.default.createElement("div", {
        className: "row"
      }, _react.default.createElement("div", {
        className: "col"
      }, _react.default.createElement("h3", null, "Enter Amount"), _react.default.createElement("input", {
      ...
      }, "Click To Get Money"), _react.default.createElement("h3", null, "Value Entered: ", this.state.value)), _react.default.createElement("div", {
        className: "col"
      }, _react.default.createElement(_Dispenser.default, {
...
var _default = GetAmount;
exports.default = _default;
},{"react":"../node_modules/react/index.js","../Dispenser":"components/Dispenser.js"}],"components/App.js":[function(require,module,exports) {
"use strict";
...
var _GetAmount = _interopRequireDefault(require("./GetAmount/GetAmount"));
...
function (_Component) {
  ...
  _createClass(App, [{
    key: "render",
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement(_GetAmount.default, null));
    }
  }]);
...
var _default = App;
exports.default = _default;
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./GetAmount/GetAmount":"components/GetAmount/GetAmount.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
